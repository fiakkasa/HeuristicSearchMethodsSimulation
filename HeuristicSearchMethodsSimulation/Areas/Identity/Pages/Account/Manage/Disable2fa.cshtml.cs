...
namespace HeuristicSearchMethodsSimulation.Areas.Identity.Pages.Account.Manage
{
    public class Disable2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            if (!await _userManager.GetTwoFactorEnabledAsync(user).ConfigureAwait(true))
            {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var disable2faResult = await _userManager.SetTwoFactorEnabledAsync(user, false).ConfigureAwait(true);
